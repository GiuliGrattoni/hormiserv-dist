import{g as o,a,b as s}from"./locationUtils.CAdnG0xJ.js";import{g as i}from"./provinces.config.CWZx6S43.js";document.addEventListener("DOMContentLoaded",()=>{const r=o();if(!r){window.location.href="/#cotizacion-trigger";return}const t=i(r);if(!t){localStorage.removeItem("hormiserv_location"),window.location.href="/";return}const e=document.getElementById("province-name");e&&(e.textContent=t.label),l(t.plants);const n=document.getElementById("quote-province");n&&(n.value=t.label)});function l(r){const t=document.getElementById("plants-container");t&&(t.innerHTML=r.map(e=>{const n=a(e.whatsapp,s(e.name));return`
